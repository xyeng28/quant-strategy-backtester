...
def test_calc_metrics_when_valid_should_return_df():
    df = pd.DataFrame(
        {'date': {0: pd.Timestamp('1990-01-03 00:00:00'), 1: pd.Timestamp('1990-01-04 00:00:00'), 2: pd.Timestamp('1990-01-05 00:00:00')}, 'ticker': {0: 'GLD', 1: 'GLD', 2: 'GLD'}, 'close_px': {0: 168.3300018310547, 1: 169.57000732421875, 2: 169.05999755859375}, 'high_px': {0: 169.00999450683594, 1: 169.72000122070312, 2: 170.92999267578125}, 'low_px': {0: 168.0, 1: 168.72999572753906, 2: 168.89999389648438}, 'open_px': {0: 168.86000061035156, 1: 168.89999389648438, 2: 170.6199951171875}, 'volume': {0: 9014400, 1: 6965600, 2: 8715600}, 'sma_fast': {0: np.nan, 1: np.nan, 2: np.nan}, 'sma_slow': {0: np.nan, 1: np.nan, 2: np.nan}, 'macd': {0: 0.0, 1: 0.09891781711851877, 2: 0.13460572310603425}, 'macd_signal': {0: 0.0, 1: 0.019783563423703757, 2: 0.042747995360169856}, 'macd_histogram': {0: 0.0, 1: 0.07913425369481501, 2: 0.0918577277458644}, 'rsi': {0: np.nan, 1: np.nan, 2: np.nan}, 'sma_cross_long': {0: False, 1: False, 2: False}, 'rsi_long_signal': {0: False, 1: False, 2: False}, 'macd_cross_long': {0: False, 1: True, 2: False}, 'rsi_recent': {0: False, 1: False, 2: False}, 'entry': {0: False, 1: False, 2: False}, 'exit': {0: True, 1: True, 2: True}, 'holding': {0: 0, 1: 0, 2: 0}, 'trade': {0: '', 1: '', 2: ''}, 'days_in_position': {0: 0, 1: 0, 2: 0}, 'position': {0: 0.0, 1: 0.0, 2: 0.0}, 'position_shrs': {0: 0.0, 1: 0.0, 2: 0.0}, 'trade_shrs': {0: 0, 1: 0, 2: 0}, 'trade_cost': {0: 0.0, 1: 0.0, 2: 0.0}, 'daily_ret_o2c': {0: 0.0, 1: 0.07366515057776857, 2: -0.0300766493835114}, 'daily_pnl': {0: 0.0, 1: 3.0, 2: -2.2}, 'cum_pnl': {0: 100000.0, 1: 100000.0, 2: 100000.0}, 'cum_ret': {0: 1.0, 1: 1.073665150577769, 2: 1.043366941103686}, 'cum_ret_pct': {0: 0.0, 1: 0.0, 2: 0.0}, 'trade_id': {0: np.nan, 1: np.nan, 2: np.nan}, 'strategy_id': {0: 'sma_macd_rsi_2026_02_19', 1: 'sma_macd_rsi_2026_02_19', 2: 'sma_macd_rsi_2026_02_19'}}
    )
    exp_df = pd.DataFrame({
        'ticker': ['GLD'],
        "total_return": [4.34],
    ...
    metrics_df = calc_metrics(df, 'GLD', initial_capital=10000)
